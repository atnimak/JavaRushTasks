                ...
                if(compareNames!=0){
                    ...
                    if(compareDates!=0){
                        ...
                        if(stock1.containsKey("change")){
                            changeFirst = (Double) stock1.get("change");
                        }else{
                            changeFirst = ((Double)stock1.get("last"))-((Double)stock1.get("open"));
                        }

                        if(stock2.containsKey("change")){
                            changeSecond = (Double) stock2.get("change");
                        }else{
                            changeSecond = ((Double)stock2.get("last"))-((Double)stock2.get("open"));
                        }

                        int compareChanges = changeSecond.compareTo(changeFirst);
